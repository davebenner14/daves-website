...
export default function IntroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-full flex justify-center mb-8 mt-[90px]"
      ...
      >
        ...
        {/* Overlay content - positioned higher using top instead of margin */}
        <div
          className="absolute inset-0 flex flex-col items-center justify-start pt-[140px] pointer-events-none"
          style={{
            fontFamily:
